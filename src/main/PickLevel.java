...
public class PickLevel {
	...
	Rectangle[] levels = { new Rectangle(60, 200, 75, 75), new Rectangle(160, 200, 75, 75),
			new Rectangle(260, 200, 75, 75), new Rectangle(360, 200, 75, 75), new Rectangle(60, 300, 75, 75),
			new Rectangle(160, 300, 75, 75), new Rectangle(260, 300, 75, 75), new Rectangle(360, 300, 75, 75) };

	Rectangle[] options = { new Rectangle(460, 8, 30, 30), new Rectangle(420, 8, 30, 30) };
